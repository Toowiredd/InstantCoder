...
export default function Home() {
  ...
  let models = [
    {
      label: "valtown-2.0-flash-exp",
      value: "valtown-2.0-flash-exp",
    },
    {
      label: "valtown-1.5-pro",
      value: "valtown-1.5-pro",
    },
    {
      label: "valtown-1.5-flash",
      value: "valtown-1.5-flash",
    }
  ];
  ...
  return (
    <main className="mt-12 flex w-full flex-1 flex-col items-center px-4 text-center sm:mt-1">
      <a
        ...
        href="https://valtown.com/docs"
        target="_blank"
      >
        <span className="text-center">
          Powered by <span className="font-medium">Valtown API</span>
        </span>
      </a>
